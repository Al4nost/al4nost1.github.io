(() => {
    ...
    (() => {
        ...
        var rangeSlider = document.getElementById("range__slider");
        if (rangeSlider) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".products-new__slider")) new core(".products-new__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                watchOverflow: true,
                observeParents: true,
        ...
        if (document.querySelector(".filter-catalog__title")) document.querySelector(".filter-catalog__title").addEventListener("click", (function(e) {
            if (window.innerHeight < 992) document.querySelector(".filter-catalog__items").classList.toggle("_active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
